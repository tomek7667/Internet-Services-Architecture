...
<div>
	...
	<button on:click={getTaskHandler}>Enter task</button>
	<button on:click={deleteTaskHandler}>Delete task</button>
	<button on:click={editTaskHandler}>Edit task</button>
</div>
