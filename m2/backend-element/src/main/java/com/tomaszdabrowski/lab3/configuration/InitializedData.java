...
public class InitializedData {
  ...
  private synchronized void init() {
    if (categoryService.findMany().size() == 0) {
      ...
      Category category1 = Category.builder().id(category1uuid).build();
      Category category2 = Category.builder().id(category2uuid).build();
      Category category3 = Category.builder().id(category3uuid).build();
      Category category4 = Category.builder().id(category4uuid).build();
      Category category5 = Category.builder().id(category5uuid).build();
      Category category6 = Category.builder().id(category6uuid).build();
